...
const heroProducts = [
    { 
        ...
        link: "../template/ProductDetails.html?name=Emerald%20Ceramic%20Pot%20Set&price=$129.99&img=cookware_category_green_1775381016223.png&cat=Cookware",
    ...
    { 
        ...
        link: "../template/ProductDetails.html?name=Smart+Kitchen+Combo&price=$199&img=https://images.unsplash.com/photo-1556910110-ad52744d7c1f?q=80&w=400&h=300&fit=crop&cat=Deals",
    ...
    { 
        ...
        link: "../template/ProductDetails.html?name=Luxury%20Sofa%20Set%20Lux&price=$1,200&img=https://images.unsplash.com/photo-1493663214224-992ca251d102?q=80&w=400&h=300&fit=crop&cat=Deals",
    ...
    { 
        ...
        link: "../template/ProductDetails.html?name=Nordic%20Minimalist%20Vase&price=$32.00&img=https://images.unsplash.com/photo-1581783598307-5bbe6ed40e5a?q=80&w=400&h=300&fit=crop&cat=Trending",
        bg: "#111827",
    ...
    { 
        ...
        link: "../template/ProductDetails.html?name=Bamboo%20Serving%20Tray&price=$24.50&img=https://images.unsplash.com/photo-1513519245088-0e12902e15ca?q=400&h=300&fit=crop&cat=Best+Deals",
        bg: "#064e3b",
    ...
    { 
        ...
        link: "../template/ProductDetails.html?name=Velvet%20Cushion%20Set&price=$45.00&img=https://images.unsplash.com/photo-1583847268964-b28dc2f51ac9?q=80&w=400&h=300&fit=crop&cat=Bestsellers",
        bg: "#4c1d95",
...
function startCarouselAutoPlay() {
    ...
    carouselTimer = setInterval(nextHeroSlide, 6000); // 6 seconds auto
}
...
function renderDynamicCategories() {
    ...
    categories.forEach((catObj, index) => {
        ...
        section.innerHTML = `
            ...
            return `
                    <div class="product-card" onclick="window.location.href='ProductDetails.html?name=${encodeURIComponent(catObj.name + ' ' + p.name)}&price=${encodeURIComponent(p.price)}&img=${encodeURIComponent(p.img)}&cat=${encodeURIComponent(catObj.name)}'">
